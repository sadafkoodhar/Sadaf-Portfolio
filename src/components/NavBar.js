...
import navIcon2 from '../assets/img/github-142-svgrepo-com.svg';
import navIcon3 from '../assets/img/whatsapp.svg';
import { HashLink } from 'react-router-hash-link';
import logo from '../assets/img/images-removebg-preview.png';
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/sadaf-koondhar-07218a318/" target="blank"><img src={navIcon1} alt="" /></a>
                <a href="https://github.com/sadafkoodhar" target="blank"><img src={navIcon2} alt="" /></a>
                <a href="https://wa.me/qr/K2MHRQWZEPNUE1" target="blank"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
